...
VALUES	(NEXT VALUE FOR codigo_curso,'Estatística', 'Cálculos e conceitos matemáticos relacionados à estatísticas.', 1),
		...
		(NEXT VALUE FOR codigo_curso,'Ciência da Computação', 'Lógica de Programação com linguagem Python e cálculos matemáticos básicos,
		Banco de Dados e técnicas/ferramentas de Data Science e IA.', 9),
		...
		(NEXT VALUE FOR codigo_curso,'Gestão de RH', 'Psicologia e prática para trabalhar com Recursos Humanos, buscando e explorando habilidades 
		das pessoas.', 2),
		(NEXT VALUE FOR codigo_curso,'Gestão Comercial', 'Administração e desenvolvimento de propagandas, vendas, gestão de projetos comerciais e
		liderança de equipe.', 2),
...
VALUES	(NEXT VALUE FOR codigo_departamento,'Exatas'), (NEXT VALUE FOR codigo_departamento,'Humanas'), 
		(NEXT VALUE FOR codigo_departamento,'Idiomas'), (NEXT VALUE FOR codigo_departamento,'Diretoria'),
		(NEXT VALUE FOR codigo_departamento,'Administração'), (NEXT VALUE FOR codigo_departamento,'Secretaria'),
...
-- Criando uma sequência CODIGO PROFESSOR
